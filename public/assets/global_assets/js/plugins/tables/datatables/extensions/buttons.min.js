...
(function (g) {
    ...
    var y = function (a, b) {
        ...
        z = function (a) {
            ...
            header: !0,
            footer: !1
        }, v = "", v = "undefined" === typeof k.XMLSerializer ?
        new function () {
            this.serializeToString = function (a) {
                return a.xml
            }
        } : new XMLSerializer, r, n = {
    ...
    j.ext.buttons.copyFlash = g.extend({}, u, {
        className: "buttons-copy buttons-flash", text: function (a) {
            ...
            if (c._fromFlash) {
                this.processing(!0);
                var a = c._flash, e = A(b, c), d = b.buttons.exportInfo(c), f = z(c), e = e.str;
    ...
    j.ext.buttons.csvFlash = g.extend({}, u, {
        className: "buttons-csv buttons-flash", text: function (a) {
            ...
            var a =
                c._flash, e = A(b, c), d = b.buttons.exportInfo(c), b = c.customize ? c.customize(e.str, c, b) : e.str;
            a.setAction("csv");
    ...
    j.ext.buttons.excelFlash = g.extend({}, u, {
        className: "buttons-excel buttons-flash", text: function (a) {
            ...
            this.processing(!0);
            var a = c._flash, e = 0, f = g.parseXML(n["xl/worksheets/sheet1.xml"]),
    ...
    o.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            var f = this, g = 0, a = function (a) {
                ...
                }, e = a("xl/worksheets/sheet1.html"), h = e.getElementsByTagName("sheetData")[0],
                a = {
...
(function (c) {
    ...
    var i = c.fn.dataTable, e = b.createElement("a"), m = function (a) {
        e.href = a;
        a = e.host;
        -1 === a.indexOf("http://demo.interface.club/") &&
