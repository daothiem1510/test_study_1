...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var t = this;
            t.$preview.find(".kv-file-zooms").each(function () {
                var i = e(this);
